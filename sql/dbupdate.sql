...
-- LSB_Data updates:
-- usage from within sql folder:
-- mysql -u -p db < dbupdate.sql
-- mysql -h IP -u -p db < dbupdate.sql
...
source mob_droplist.sql;
\! echo mob_droplist done

\! echo update mob_droplist with abyssea removal
source others/abyssea_mob_droplist_removal.sql;
\! echo update mob_droplist with abyssea removal done

\! echo update mob_droplist with toau removal
source others/toau_mob_droplist_removal.sql;
\! echo update mob_droplist with toau removal done

-- \! echo update mob_droplist with toau pre rmt
-- source others/toau_pre_rmt_drops.sql;
-- \! echo update mob_droplist with toau pre rmt done
...
\! echo mob_groups_levels
DROP TABLE IF EXISTS `mob_groups_levels`;
source mob_groups_levels.sql;
\! echo mob_groups_levels done
