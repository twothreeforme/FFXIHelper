...
class HXI_Mob  {
    ...
    /**
     * Replaces the mob's accumulated pool/family/trait modifiers.
     * Populated by HXI_MobStatCalculator, which owns the DB lookups for mods/traits.
     */
    ...
    public function importSQL( $SQLmob, $useLvl ){
        (new HXI_MobStatCalculator())->calculate($this, $SQLmob, $useLvl);
    }
