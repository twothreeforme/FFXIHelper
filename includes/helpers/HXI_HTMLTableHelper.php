...
class HXI_HTMLTableHelper {
	...
	public static function shareButton($buttonID, $label = null){
		$text = $label ? "<span class=\"HXI_btn_label\">$label</span>" : "";
		$title = $label ? "" : " title=\"Copy link\"";
		return "<button type=\"button\" id=\"$buttonID\" class=\"HXI_dynamiccontent_shareButton\"$title >
	...
	public static function shareDiscordButton($buttonID, $label = null){
		$text = $label ? "<span class=\"HXI_btn_label\">$label</span>" : "";
		$title = $label ? "" : " title=\"Copy link for Discord\"";
		return "<button type=\"button\" id=\"$buttonID\" class=\"HXI_dynamiccontent_shareDiscordButton\"$title >
			<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"22\" height=\"22\" fill=\"currentColor\" viewBox=\"0 0 16 16\">
    ...
    public static function tableHeader_DropRates($showTH){
		...
		<table id=\"LSBSearch_dropstable\" class=\"horizon-table general-table sortable\">
			<tr><th>Zone Name</th>
			<th>Mob Name</th>
			<th>Family</th>
			<th>Lvl Min</th>
	...
	{		
		...
		foreach ( $dropRatesArray as $row ) {
			 ...
			 */
			$html .= "<td><table id=\"LSBSearch_dropstable2\" >";
	...
	public static function table_FishingQuery($queryResults){
		$html = "<br><div ><i></i></div>
		<div style=\"max-height: 900px; overflow: auto; display: inline-block; width: 100%;\">
		<table id=\"LSBSearch_fishingtable\" class=\"horizon-table general-table sortable\">
			<tr><th>Fish</th>
			<th>Zone</th>
			<th>Bait</th>
			</tr>
	...
	public static function table_mobDetails(Array $moblist){
		...
		*/
		...
		// wfDebugLog( 'LSBSearch', get_called_class() . ":"  . json_encode($statsmap ));
